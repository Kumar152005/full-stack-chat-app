...
const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-base-200 container mx-auto px-4 pt-20 pb-10 max-w-5xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-semibold">Theme</h2>
          <p className="text-sm text-base-content/70">
            Choose colors that feel comfortable for your chat interface.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
                group flex flex-col items-center gap-2 p-2 rounded-xl border transition-all
                ${
                  theme === t
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Kumar Harsh</h3>
